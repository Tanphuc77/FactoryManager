...
-- Dumping data for table factorymanager.permission: ~9 rows (approximately)
INSERT INTO `permission` (`id`, `create_at`, `name`, `description`, `update_at`, `group_id`) VALUES
	(1, '2025-04-16 06:45:07.000000', 'VIEW_USER', 'Xem danh sách người dùng', '2025-04-16 06:45:07.000000', 1),
	(2, '2025-04-16 06:45:07.000000', 'ADD_USER', 'Thêm người dùng', '2025-04-16 06:45:07.000000', 1),
	(3, '2025-04-16 06:45:07.000000', 'EDIT_USER', 'Chỉnh sửa người dùng', '2025-04-16 06:45:07.000000', 1),
	(4, '2025-04-16 06:45:07.000000', 'DELETE_USER', 'Xoá người dùng', '2025-04-16 06:45:07.000000', 1),
	(5, '2025-04-16 06:45:07.000000', 'VIEW_ADMIN', 'Xem danh sách Admin', '2025-04-16 06:45:07.000000', 1),
	(6, '2025-04-16 06:45:07.000000', 'ADD_ADMIN', 'Thêm Admin', '2025-04-16 06:45:07.000000', 1),
	(7, '2025-04-16 06:45:07.000000', 'EDIT_ADMIN', 'Chỉnh sửa Admin', '2025-04-16 06:45:07.000000', 1),
	(8, '2025-04-16 06:45:07.000000', 'DELETE_ADMIN', 'Xóa Admin', '2025-04-16 06:45:07.000000', 1),
	(9, '2025-04-16 06:45:07.000000', 'VIEW_DASHBOARD', 'Xem dashboard hệ thống', '2025-04-16 06:45:07.000000', 2);

-- Dumping structure for table factorymanager.permission_group
...
-- Dumping data for table factorymanager.permission_group: ~2 rows (approximately)
INSERT INTO `permission_group` (`id`, `name`, `description`, `create_at`, `update_at`) VALUES
	(1, 'User Management', 'Quản lý người dùng', '2025-04-16 06:44:51.000000', '2025-04-16 06:44:51.000000'),
	(2, 'System', 'Các quyền hệ thống', '2025-04-16 06:44:51.000000', '2025-04-16 06:44:51.000000');
...
INSERT INTO `role` (`id`, `name`, `description`, `create_at`, `update_at`) VALUES
	(1, 'SUPER ADMIN', 'Toàn quyền hệ thống, bao gồm quản lý Admin', '2025-04-11 14:06:38.000000', '2025-04-11 14:06:38.000000'),
	(2, 'ADMIN', 'Quản lý nội dung hệ thống, không quản lý được các Admin khác', '2025-04-16 10:31:48.000000', NULL),
...
-- Dumping data for table factorymanager.role_permission: ~0 rows (approximately)
...
-- Dumping data for table factorymanager.user_token: ~0 rows (approximately)
INSERT INTO `user_token` (`id`, `user_id`, `token`, `token_type`, `device_info`, `issued_at`, `expiry_at`, `is_valid`, `created_at`, `updated_at`) VALUES
	('09a61b89-281c-4ae9-9506-4c34169f2154', '24379ed8-55c4-4981-ae88-26df52a43c0b', 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJ0aG9uZ25ndXllbiIsInNjb3BlIjoiUk9MRV9BRE1JTiIsImlzcyI6IlNwcmluZ0Jvb3REYXRhYmFzZS5jb20iLCJleHAiOjE3NDQ3OTQ4NTAsImlhdCI6MTc0NDc5MTI1MCwianRpIjoiMWNiYjliYTgtYjY4Mi00YjQ3LWE0Y2MtNmU1ZmU4OGY5ZTM5In0.Tgu3mPlEqE0WhKm64rsyFlYpJJ8VXwx_XOp8ulE8TPprSazrDAfoMAOuuYbcPA9Hi_m6c09f8N_jKE8n2WI4WA', 'Bearer', 'WEB', '2025-04-16 15:14:10.163463', '2025-04-23 15:14:10.163463', b'1', '2025-04-16 15:14:10.163463', '2025-04-16 15:14:10.163463');
